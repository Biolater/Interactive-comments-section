...
const CommentItem: React.FC<{
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="comment-item bg-neutral-white p-4 sm:p-6 md:p-8 rounded flex flex-col lg:flex-row lg:items-center gap-3 lg:gap-5">
        {/* Vote Status */}
        <div className="hidden lg:block">
          <div className="flex flex-col lg:items-center gap-4 p-3 rounded-lg bg-neutral-veryLightGray">
            <button
        ...
        <div className="flex flex-col gap-3 lg:gap-4 lg:w-full">
          {/* Comment Header */}
